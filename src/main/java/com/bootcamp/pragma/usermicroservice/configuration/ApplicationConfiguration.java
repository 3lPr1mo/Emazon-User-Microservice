...
public class ApplicationConfiguration {
    ...
    public AuthenticationProvider authenticationProvider() {
        DaoAuthenticationProvider autDao = new DaoAuthenticationProvider();
        autDao.setUserDetailsService(userDetailsService());
        autDao.setPasswordEncoder(passwordEncoder());
        return autDao;
    }
